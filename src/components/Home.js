...
const Home = () => {
  ...
  useEffect(() => {
    ...
    [wsBTC, wsETH, wsDOGE].forEach((ws) => {
      ...
      ws.onclose = () => console.log("WebSocket disconnected:", ws.url);
    });
    ...
    <div className="App">
      <header className="header">
        ...
        <div className="crypto-prices">
          <div className="crypto">
            ...
            <span className="price">${cryptoData.bitcoin.usd.toLocaleString()}</span>
            <span className={`change ${cryptoData.bitcoin.usd_24h_change >= 0 ? "positive" : "negative"}`}>
          ...
          <div className="crypto">
            ...
            <span className="price">${cryptoData.ethereum.usd.toLocaleString()}</span>
            <span className={`change ${cryptoData.ethereum.usd_24h_change >= 0 ? "positive" : "negative"}`}>
          ...
          <div className="crypto">
            ...
            <span className={`change ${cryptoData.dogecoin.usd_24h_change >= 0 ? "positive" : "negative"}`}>
      ...
      <main>
        <div className="profile-section">
          <img
            src={`${process.env.PUBLIC_URL}/elon.png`}
            alt="Elon Musk"
          ...
          <h2>
            ...
            <span className="verified-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 2 L14.5 8.5 L21 9 L16 14 L17.5 20.5 L12 17 L6.5 20.5 L8 14 L3 9 L9.5 8.5 L12 2 Z" fill="#f7931a" />
                <path d="M9 12 L11 14 L15 10" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </span>
          </h2>
